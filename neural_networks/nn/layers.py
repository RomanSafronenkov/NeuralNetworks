...
from neural_networks.nn import BaseLayer
...
class MaxPool2D(BaseLayer):
    ...
    def _add_padding(self, input_tensor: np.array) -> np.array:
        ...
        padded_map[self.padding:self.padded_width_in - self.padding,
        self.padding:self.padded_height_in - self.padding] = input_tensor
        return padded_map
